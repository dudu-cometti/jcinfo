...
insert into public.products (
  name, slug, description, category_id, brand_id, model,
...
select
  ...
  p.model, p.price, p.promo_price, p.cost, p.stock, p.min_stock,
...
) as p(name, slug, description, category_slug, brand_slug, model, price, promo_price, cost, stock, min_stock, sku, internal_code, featured)
on conflict (slug) do nothing;
